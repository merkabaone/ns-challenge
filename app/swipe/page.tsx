...
const MOCK_PROFILES: Profile[] = [
  {
    ...
    interests: ['AI & Machine Learning', 'Building Products', 'Fitness & Sports', 'Reading & Writing'],
    connection_preference: 'Co-work Session',
  ...
  },
  {
    ...
    display_name: 'Maya',
    profile_picture_url: null,
    interests: ['Health & Wellness', 'Meditation & Mindfulness', 'Community Building', 'Cooking & Nutrition'],
    connection_preference: 'Workout (The Burn)',
    availability: 'Mornings',
  ...
  },
  {
    ...
    profile_picture_url: null,
    interests: ['Travel & Adventure', 'Photography & Video', 'Exploring Cities', 'Language Learning'],
    connection_preference: 'Grab a Meal',
  ...
  },
  {
    ...
    display_name: 'Jordan',
    profile_picture_url: null,
    interests: ['Blockchain & Web3', 'Investing & Finance', 'Art & Design', 'Gaming & Esports'],
